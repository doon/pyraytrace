...
class TestMatrix(unittest.TestCase):
    ...
    def test_identity_matrix(self):
        ...
        self.assertEqual(m1 * Identity(), m1)
        t1 = Tuple(1, 2, 3, 4)
        self.assertEqual(Identity() * t1, t1)
    ...
    def test_transpose(self):
        ...
        id = Identity()
        self.assertEqual(id.transpose(), Identity())
    ...
    def test_sub_matrix(self):
        ...
        m2 = Matrix([[-6, 1, 1, 6], [-8, 5, 8, 6], [-1, 0, 8, 2], [-7, 1, -1, 1]])
        expected2 = Matrix([[-6, 1, 6], [-8, 8, 6], [-7, -1, 1]])
